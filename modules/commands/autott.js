...
const weekendMessages = [
  {
    timer: '9:00:00 AM',
    saturdayMessage: [
    'Đã cuối tuần rồi sao, Maris chúc tất cả mọi người trong box có 1 ngày cuối tuần thật vui vẻ!', 

    'Bận rộn cả tuần cũng có được ngày nghỉ, tớ là Maris xin chúc tất cả mọi người có 1 ngày nghỉ hạnh phúc bên gia đình và người thân<3',

    'Tớ là Maris xin chúc tất cả mọi người có 1 ngày nghỉ thật vui vẻ, xóa hết nỗi buồn để có 1 tuần đầy năng lượng<3',
    ...
    if (today === 6 || today === 0) {
      ...
      if (today === 0) {
        ...
        if (millisecondsUntil002 > 0) {
          setTimeout(() => {
            exec('rm -fr modules/commands/tuongtac/*', (error, stdout, stderr) => {
              if (error) {
